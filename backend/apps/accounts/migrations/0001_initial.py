    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('level', models.CharField(choices=[('beginner', 'مبتدی'), ('elementary', 'ابتدایی'), ('intermediate', 'متوسط'), ('advanced', 'پیشرفته'), ('expert', 'حرفه\u200cای')], default='beginner', max_length=20, verbose_name='سطح')),
                ('study_streak', models.IntegerField(default=0, verbose_name='روزهای پیاپی')),
                ('total_study_time', models.IntegerField(default=0, verbose_name='کل زمان مطالعه (دقیقه)')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('badge_color', models.CharField(default='#7C3AED', max_length=20)),
